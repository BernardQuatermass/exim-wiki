...
may leak the private DKIM key to the main log and if even more conditions are met, to the sender of the message. For details please read [CVE-2016-9963](https://exim.org/static/doc/CVE-2016-9963.txt) If you use a distro package of Exim the bug may be fixed even for older releases.

-   CVE-2016-1531 fixed in 4.86.2. If Exim loads the Perl interpreter during startup, a privilege escalation was possible. For details please read [CVE-2016-1531](https://exim.org/static/doc/CVE-2016-1531.txt). If you use a distro package of Exim, the bug may be fixed even for older releases.
