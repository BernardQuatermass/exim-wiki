...
with DANE.
It is written by one of the Exim maintainers and has been stable for some time; it supports an optional Nagios compatible mode of operation, amongst others.
