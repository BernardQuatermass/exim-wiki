...
- [Q5005 - I used *gv* 3.5.8 (*ghostview*) to try printing *spec.ps*. After every printed page, the printer ejects a blank sheet. Is this something to do with using  letter > rather than A4 paper?](Q5005)
...
- [Q5013 - What does  Exim > stand for?](Q5013)
- [Q5014 - Although I haven't set `check_spool_space`, Exim is still checking the](Q5014)
- [Q5015 - I just noticed log entries that start off `<= <>`. Am I correct in assuming that the `<>` indicates that the envelope did not contain any  From > data?](Q5015)
