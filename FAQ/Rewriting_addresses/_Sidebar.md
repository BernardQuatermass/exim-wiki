...
- [I'm using this rewriting rule to change login names into _friendly_ names, but if mail comes in for an upper case login name, it doesn't get rewritten.](Q0804)
